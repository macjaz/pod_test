 ...
 **/
@interface GroupMessageNotifyRoot : GPBRootObject
@end

#pragma mark - GroupMessageNotify

typedef GPB_ENUM(GroupMessageNotify_FieldNumber) {
  GroupMessageNotify_FieldNumber_MessageId = 1,
  GroupMessageNotify_FieldNumber_From = 2,
  GroupMessageNotify_FieldNumber_To = 3,
  GroupMessageNotify_FieldNumber_GroupId = 4,
  GroupMessageNotify_FieldNumber_DeviceType = 5,
  GroupMessageNotify_FieldNumber_Body = 6,
  GroupMessageNotify_FieldNumber_SourceLabel = 7,
  GroupMessageNotify_FieldNumber_TargetLabel = 8,
  GroupMessageNotify_FieldNumber_Domain = 9,
};

@interface GroupMessageNotify : GPBMessage
