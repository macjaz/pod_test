 ...
 **/
@interface ChatMessageNotifyRoot : GPBRootObject
@end

#pragma mark - ChatMessageNotify

typedef GPB_ENUM(ChatMessageNotify_FieldNumber) {
  ChatMessageNotify_FieldNumber_MessageId = 1,
  ChatMessageNotify_FieldNumber_From = 2,
  ChatMessageNotify_FieldNumber_To = 3,
  ChatMessageNotify_FieldNumber_DeviceType = 4,
  ChatMessageNotify_FieldNumber_Body = 5,
  ChatMessageNotify_FieldNumber_SourceLabel = 6,
  ChatMessageNotify_FieldNumber_TargetLabel = 7,
  ChatMessageNotify_FieldNumber_Domain = 8,
};

@interface ChatMessageNotify : GPBMessage
