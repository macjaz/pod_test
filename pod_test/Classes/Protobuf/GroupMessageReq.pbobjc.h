 ...
 **/
@interface GroupMessageReqRoot : GPBRootObject
@end

#pragma mark - GroupMessageReq

typedef GPB_ENUM(GroupMessageReq_FieldNumber) {
  GroupMessageReq_FieldNumber_MessageId = 1,
  GroupMessageReq_FieldNumber_From = 2,
  GroupMessageReq_FieldNumber_GroupId = 3,
  GroupMessageReq_FieldNumber_DeviceType = 4,
  GroupMessageReq_FieldNumber_Body = 5,
  GroupMessageReq_FieldNumber_SourceLabel = 6,
  GroupMessageReq_FieldNumber_TargetLabel = 7,
  GroupMessageReq_FieldNumber_Domain = 8,
};
